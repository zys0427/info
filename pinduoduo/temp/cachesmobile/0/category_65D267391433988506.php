<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:70:"D:/APMServ5.2.6/www/htdocs/haohaios/mobile/themes/default/category.dwt";i:1;s:80:"D:/APMServ5.2.6/www/htdocs/haohaios/mobile/themes/default/library/goods_list.lbi";}s:7:"expires";i:1433992106;s:8:"maketime";i:1433988506;}<!DOCTYPE html>
        ...
        <form id="searchForm" name="searchForm" method="get" action="search.php" onSubmit="return checkSearchForm()" >
          <div class="s-combobox s-combobox-shown" style="" aria-disabled="false" aria-pressed="false">
            ...
            <div class="s-combobox-input-wrap">
              <input name="keywords" type="text" id="keyword" value="CDMA手机" class="s-combobox-input"/>
            </div>
          </div>
...
<form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur">
        <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合
        </a> 
      </li>
      <li class="">
      	<a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list">人气
        <i class="f-ico-arrow-d"></i>
        </a>
      </li>
      <li class="">
      <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">销量</a></li>
      <li class="">
      	<a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格
            <span>
...
<div style="height: 39px; display: none;" class="filter-placeholder"></div>
  <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
        <div class="srp j_autoResponsive_container m-ks-autoResponsive-container m-animation album" id="J_ItemList" style="opacity: 1; "> 
            ...
            <div class="product"  >
        <div class="pro-inner">
          <div class="proImg-wrap"> <a href="goods.php?id=8" > <img src="../images/200905/goods_img/8_G_1241425513055.jpg" alt="飞利浦9@9v"> </a> </div>
          <div class="proInfo-wrap">
            <div class="proTitle"> <a href="goods.php?id=8" >飞利浦9@9v</a> </div>
            ...
            <div class="proSales">月销:<em>1</em></div>
            <div class="proIcons"> 
			  
			<img src="themes/default/images/watermark_new_small.png" alt="飞利浦9@9v" />
...
</script>    <div class="floatingCircles">
        ...
        <div class="pagenav" id="J_PageNav">
          ...
          <div class="pagenav-cur " >
            ...
            <select name="page" class="pagenav-select">
              ...
              <option value="category.php?id=2&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">1</option>
                                    </select>
          </div>
      ...
      <div class="j_Brand attr brandAttr">
        ...
        <div class="attrValues">
          <ul class="av-collapse" style="" id="av_brands">
            ...
            <input type="hidden" class="hid_b" value="0"/>
                        <li class=""><a href="javascript:;" >飞利浦</a></li>
            <input type="hidden" class="hid_b" value="4"/>
                                  </ul>
      ...
      <div class="j_Cate attr cateAttr">
        ...
        <div class="attrValues">
          <ul class="av-collapse" style="" id="av_category">
          	               <li class=""><a href="javascript:;" data-id="51536001">CDMA手机</a></li>
              <input type="hidden" class="hid_b" value="2"/>
                          <li class=""><a href="javascript:;" data-id="51536001">GSM手机</a></li>
              <input type="hidden" class="hid_b" value="3"/>
                          <li class=""><a href="javascript:;" data-id="51536001">3G手机</a></li>
              <input type="hidden" class="hid_b" value="4"/>
                          <li class=""><a href="javascript:;" data-id="51536001">双模手机</a></li>
              <input type="hidden" class="hid_b" value="5"/>
