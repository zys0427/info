...
?>
  ...
  <tr>
    <td align="center" valign="top" class="first-cell">
    ...
    <td align="center"><?php echo nl2br($this->_var['module']['desc']); ?></td>
    <td align="center" valign="top"><?php echo $this->_var['module']['version']; ?></td>
    ...
    <td align="center" valign="top"> <?php if ($this->_var['module']['install'] == 1): ?> <span onclick="listTable.edit(this, 'edit_order', '<?php echo $this->_var['module']['code']; ?>'); return false;"><?php echo $this->_var['module']['pay_order']; ?></span> <?php else: ?> &nbsp; <?php endif; ?> </td>
