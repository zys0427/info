 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: goods.php 16345 2009-06-24 09:36:23Z pangbin $
*/
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $hhs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
    ...
    if ((isset($_POST['attr_id_list']) && isset($_POST['attr_value_list'])) || (empty($_POST['attr_id_list']) && empty($_POST['attr_value_list'])))
    {
        ...
        $sql = "SELECT * FROM " . $hhs->table('goods_attr') . " WHERE goods_id = '$goods_id'";
...
elseif ($_REQUEST['act'] == 'drop_goods_article')
{
    ...
    $sql = "DELETE FROM " .$hhs->table('goods_article') . " WHERE " . db_create_in($articles, "article_id");
    $db->query($sql);
