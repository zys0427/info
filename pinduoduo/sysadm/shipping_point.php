...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO " .$hhs->table('shipping_point').
            " (shop_name, province,city,district, address,longitude,latitude,tel) ".
            "VALUES".
            " ('$_POST[shop_name]', '$_POST[province]','$_POST[city]','$_POST[district]','$_POST[address]','$_POST[longitude]','$_POST[latitude]','$_POST[tel]' )";
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    $sql = "UPDATE " .$hhs->table('shipping_point').
            " SET shop_name='$_POST[shop_name]', ".
                "province='$_POST[province]',city='$_POST[city]' ,longitude='$_POST[longitude]' ,latitude='$_POST[latitude]' ,tel='$_POST[tel]',district='$_POST[district]',".
