 ...
 * 电商 订单管理
 * ============================================================================
 * 版权所有 2005-2010 西安网络科技有限公司，并保留所有权利。
...
function order_list($refund_ex="",$is_page=true)
{
    ...
    if ($result === false)
    {
        ...
        /* 查询 */
        if($is_page){
            $sql = "SELECT o.transaction_id,o.team_status,u.uname,o.team_sign,o.team_first, o.order_id, o.order_sn, o.add_time,o.pay_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
 ...
 */
        ...
        /* 查询 */
        $sql ="SELECT o.discount_type,o.discount_amount,o.team_num,u.uname,o.transaction_id,o.teammen_num,(o.team_num-o.teammen_num) as team_lack_num, o.team_status,o.team_sign,o.team_first,o.extension_code, o.order_id, o.order_sn, o.add_time,o.pay_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
            "o.pay_status, o.consignee, o.address, o.email, o.tel,  o.extension_id, " .
            "(" . order_amount_field('o.') . ") AS total_fee, " .
