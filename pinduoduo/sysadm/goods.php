...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if (!empty($is_url_goods_img))
    {
        if(is_file(ROOT_PATH . $original_img)){
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $hhs->table('goods') . " (subscribe,limit_buy_one,limit_buy_bumber,discount_type,discount_amount,is_nearby,sales_num,little_img,team_num,team_price,goods_name, goods_name_style, goods_sn, " .
                ...
                "VALUES ('$subscribe','$limit_buy_one','$limit_buy_bumber','$discount_type','$discount_amount','$is_nearby' ,'$sales_num','$little_img','$team_num','$team_price','$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
