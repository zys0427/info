...
{
	$sql = "select g.goods_name,g.goods_thumb,g.little_img,g.goods_id,og.goods_price,g.shop_price,og.refund_status,og.goods_number,og.refund_add_time,og.refund_confirm_time,og.goods_price*og.goods_number as refund_money,og.refund_reason,og.refund_desc,og.rec_id,og.goods_attr,og.refund_pic1,og.refund_pic2,og.refund_pic3 from ".$GLOBALS['hhs']->table("order_goods")." as og left join ".$GLOBALS['hhs']->table("goods")." as g on g.goods_id=og.goods_id where og.order_id='$order_id' ".$where_ex;
